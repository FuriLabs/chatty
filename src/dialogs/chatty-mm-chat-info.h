...
G_DECLARE_FINAL_TYPE (ChattyMmChatInfo, chatty_mm_chat_info, CHATTY, MM_CHAT_INFO, HdyPreferencesPage)

GtkWidget  *chatty_mm_chat_info_new                  (GtkWindow *parent_window);
void        chatty_mm_chat_info_set_item             (ChattyMmChatInfo *self,
                                                      ChattyChat       *chat);
